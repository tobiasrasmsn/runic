...
export default function Hero() {
    ...
    return (
        <>
            <section className="bg-zinc-900 w-full h-[100dvh] min-h-[500px] px-2 pb-2">
                <div className="bg-gradient-to-tr from-[#D9D9D9] to-[#D9D9D9] relative w-full h-full flex flex-col items-center justify-center gap-1 rounded-b-[2rem] overflow-hidden">
                    <AnimatedGridPattern
                        numSquares={30}
                        maxOpacity={0.1}
                        duration={3}
                    ...
                    />
                    <WordPullUp className="text-4xl font-normal text-zinc-700" words="Rediscover the Runes" />
